...
SECRET_KEY = '1bifk3snw**nmd9&ip7i(rh8k(tyzao=8us$9jbpwte0yia2yv'
...
GENERATED_STATIC_HTML_FILES_DIR = os.path.join(os.path.dirname(BASE_DIR), './front/xiao')
